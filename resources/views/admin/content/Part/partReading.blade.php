    ...
    <div class="relative w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4 modal-form" action="{{url('/TambahPartReadingAdmin')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                        <label for="name" class="block mb-2 text-sm font-semibold text-gray-900">Part<span class="text-red-500">*</span></label>
