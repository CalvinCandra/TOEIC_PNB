                        ...
                        <table class="w-full text-sm text-left text-gray-500 table-auto">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3 border-2 whitespace-nowrap pe-[300px]">Multiple
                                        Question</th>
        ...
        <div class="relative w-full max-w-4xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4 modal-form" action="{{ url('/TambahPartReadingAdmin') }}" method="POST"
                        ...
                        <div>
                            <label for="name" class="block mb-2 text-sm font-semibold text-gray-900">Part<span
        ...
        <div id="UpdatePart{{ $data->id_part }}" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-4xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <!-- Modal body -->
                    <div class="p-4 md:p-5">
                        <form class="space-y-4 modal-form" action="{{ url('/UpdatePartReadingAdmin') }}" method="POST">
                            @csrf
                            ...
                            <div>
                                ...
                                <textarea rows="5" name="multi" id="editorUpdate{{ $data->id_part }}"
                                    class="editorMulti p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500">{{ $data->multi_soal }}</textarea>
                            </div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative p-4 text-center bg-white rounded-lg shadow ">
                ...
                <div class="flex justify-center items-center space-x-4">
                    <form class="modal-form" action="{{ url('/DeletePartReadingAdmin') }}" method="POST">
                        @csrf
