                    ...
                    <form class="space-y-4" action="{{ url('/TambahSoalListeningAdmin') }}" method="POST">
                        ...
                        <div>
                            ...
                            <textarea rows="5" name="text"
                                ...
                                placeholder="You can leave it blank"></textarea>
                        </div>

                        <div>
                            <label class="block mb-2 text-sm font-semibold text-gray-900">Question<span
                        ...
                        <form class="space-y-4" action="{{ url('/UpdateSoalListeningAdmin') }}" method="POST">
                            ...
                            <div>
                                ...
                                <textarea rows="5" name="text"
                                    ...
                                    placeholder="You can leave it blank">{{ $data->text }}</textarea>
                            </div>
