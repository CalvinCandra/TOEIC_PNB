                        ...
                        <tbody>
                            ...
                            <tr class="border-b" id="baris{{$data->nomor_soal}}">
                                ...
                                <td class="px-4 py-3 border-2 whitespace-nowrap">
                                    <a class="" href="{{ asset('storage/gambar/'.$data->gambar->gambar) }}"
                                ...
                                <td class="px-4 py-3 border-2 whitespace-nowrap">
                                    <a class="" href="{{ asset('storage/gambar/'.$data->gambar1->gambar) }}"
                                        data-lightbox="example-1" target="__blank" id='link-foto'>
                                        <h1 class="text-sky-500 italic font-weight-bold hover:underline">See Image</h1>
                                    </a>
                                </td>
                                ...
                                <td class="px-4 py-3 border-2 whitespace-nowrap">
                                    <a class="" href="{{ asset('storage/gambar/'.$data->gambar2->gambar) }}"
                                        data-lightbox="example-1" target="__blank" id='link-foto'>
                                        <h1 class="text-sky-500 italic font-weight-bold hover:underline">See Image</h1>
                                    </a>
                                </td>
                                ...
                                <td class="px-4 py-3 border-2">
                                    <ul class="flex py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                        <li>
                                            <button type="button" data-modal-target="UpdateSoal{{$data->id_soal}}"
                                        ...
                                        <li>
                                            <button onclick="hapus('baris{{$data->nomor_soal}}', '{{$data->id_soal}}')"
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4 modal-form" action="{{url('/TambahSoalReadingAdmin')}}" method="POST">
                    ...
                    <div>
                        <label for="name" class="block mb-2 text-sm font-semibold text-gray-900">Number Question<span
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-semibold text-gray-900">Supporting sentences
                            (Opsional)</label>
                        <p class="text-sm italic text-gray-500 -mt-3"><span class="font-semibold">Note :</span>If there
                ...
                <form class="space-y-4 modal-form" action="{{url('/UpdateSoalReadingAdmin')}}" method="POST">
                    ...
                    <div class="">
                        ...
                        <select id="countries" name="gambar"
                            ...
                            <option value="{{$item->id_gambar}}">{{$item->gambar}}</option>
                            @endforeach
                            <option value="" class="text-red-500 italic">Remove Image From Question</option>
                            @endif
                        </select>
                    </div>
