<footer class="bg-[#1D3752] py-14 px-4 lg:px-8" id="contact">
    <div class="max-w-screen-xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-10 mb-10">
            ...
            <div>
                ...
                <a href="mailto:language-center@pnb.ac.id"
                    class="text-base font-normal text-brand-muted no-underline hover:underline">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex gap-3">
                        <a href="#"
                            class="w-9 h-9 rounded-lg bg-brand-hover flex items-center justify-center text-slate-400 hover:text-white hover:bg-brand transition-colors no-underline">
                            <i class="fa-brands fa-facebook-f text-sm"></i>
                        </a>
                        <a href="#"
                            class="w-9 h-9 rounded-lg bg-brand-hover flex items-center justify-center text-slate-400 hover:text-white hover:bg-red-500 transition-colors no-underline">
                            <i class="fa-brands fa-youtube text-sm"></i>
                        </a>
                        <a href="#"
                            class="w-9 h-9 rounded-lg bg-brand-hover flex items-center justify-center text-slate-400 hover:text-white hover:bg-pink-500 transition-colors no-underline">
            ...
            <div>
                ...
                <div class="aspect-square w-full rounded-xl overflow-hidden border border-brand-hover">
                    <iframe
        ...
        <div class="border-t border-brand-hover pt-6 text-center">
