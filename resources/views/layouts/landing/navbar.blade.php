...
<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://www.pnb.ac.id/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="{{ asset('img/PNB.png') }}" class="h-10" alt="PNB Logo">
            <div class="flex flex-col items-center">
                <span class="block text-base font-extrabold whitespace-nowrap dark:text-white flex-grow flex-basis-0">TOEIC
                    SIMULATION</span>
