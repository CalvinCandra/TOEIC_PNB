            ...
            <div class="w-full flex flex-col lg:w-2/4 mx-5 my-5 lg:mt-14">
                ...
                <form action="{{url('/ProsesLogin')}}" method="post" class="flex flex-col w-full">
                    ...
                    <input type="email" name="email" id=""
                        class="rounded-lg bg-[#F3F4F6] pl-3 border-none focus:ring-2 placeholder:italic"
                    ...
                    <div class="relative">
                        <input type="password" name="password" id="inputPassword"
                            class="block w-full rounded-lg bg-[#F3F4F6] pl-3 mt-5 border-none focus:ring-2 placeholder:italic"
                            placeholder="Your Password">
                        <span class="absolute end-2.5 bottom-[8px] cursor-pointer icon"><i
                    ...
                    <button type="submit"
                        class="bg-sky-500 rounded-full my-5 py-2 text-white font-semibold hover:bg-sky-600">Continue</button>
                </form>

                <p class="text-center lg:text-base text-sm">By continuing, you agree to the updated <span
                        class="font-semibold">Terms of Sale, Terms of Service</span>, and <span
                        class="font-semibold">Privacy Policy.</span></p>
