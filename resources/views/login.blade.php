        ...
        <div class="flex bg-white rounded-md shadow-md">
            ...
            <div class="w-full flex flex-col lg:w-2/4 mx-5 my-5 lg:mt-14">
                ...
                <form action="{{url('/ProsesLogin')}}" method="post" class="flex flex-col w-full">
                    ...
                    <input type="email" name="email" id="" class="rounded-full bg-slate-50 pl-5 placeholder:italic" placeholder="Enter Your Email" value="{{old('email')}}">
                    @error('email')
                    ...
                    <input type="password" name="password" id="" class="rounded-full pl-5 placeholder:italic" placeholder="Enter Your Password">
                    @error('password')
                        <div class=" mt-1 text-sm italic text-red-400">
                            {{$message}}
                        </div>
