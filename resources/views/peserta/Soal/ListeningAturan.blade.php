...
<body style="font-family: 'Poppins'" class="bg-gray-100">
    ...
    <div class="h-full flex justify-center items-center">
        <div class="bg-white m-4 py-5 px-8 h-full w-full rounded-lg overflow-y-auto">
            ...
            <div class="flex-warp md:flex md:justify-between md:items-center">
                ...
                <a href="{{url('/SoalListening')}}" onclick="startQuiz()" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Start Test Listening</a>
            </div>
        </div>
    </div>
    ...
    {{-- redirect ke halaman Readingtest --}}
    <script>
