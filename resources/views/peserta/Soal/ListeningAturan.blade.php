    ...
    <div class="bg-white m-4 py-5 px-8 h-full w-full rounded-lg overflow-y-auto">
        ...
        <div class="bg-gray-100 h-[32rem] m-4 md:m-6 overflow-y-auto px-5 py-6"> 
            <ol class="space-y-5 text-black list-decimal list-inside text-justify">
                ...
                <li>
                    <span class="font-bold">No Writing During Listening:</span> Writing or marking on any materials during the listening section is strictly prohibited as the time is also limited. Answers should be recorded only during designated answer periods.
                </li>

                <li>
                    <span class="font-bold">Total Listening Questions:</span> On the listening test, there are 100 questions that you must answer. The question type is multiple choice.
                </li>

                <li>
                    <span class="font-bold">Total Times Listening:</span> In the listening test, the total time given to complete this test is 45 minutes.
                </li>
        ...
        <div class="flex-warp md:flex md:justify-between md:items-center">
            ...
            <button id="startQuizButton" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Start Listening Test</button>
        </div>
    </div>
</div>
