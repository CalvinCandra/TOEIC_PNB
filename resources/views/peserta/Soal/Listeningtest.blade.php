...
<div class="flex items-center gap-3">
    <div class="hidden sm:block text-slate-500 font-medium text-xs"><i class="fa-solid fa-headphones mr-1 text-slate-400"></i> Listening</div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" id="petunjuk">
        ...
        <div class="bg-slate-50 border-b border-slate-200 p-4 flex items-center justify-between">
            <h1 class="text-[15px] font-bold text-slate-800 flex items-center gap-2">
                <span class="bg-indigo-100 text-indigo-700 px-2 py-0.5 rounded-md shadow-inner text-xs uppercase tracking-wider">{{$part->part}} Listening</span>
        ...
        <div class="p-5 md:p-6">
            ...
            <div class="flex flex-col gap-3 mt-4">
                ...
                <div class="bg-slate-50 rounded-xl p-3 border border-slate-100 w-full sm:w-max">
                    <p class="text-[11px] text-slate-400 font-bold uppercase tracking-widest mb-2 ml-1"><i class="fa-solid fa-volume-high mr-1"></i> Part Audio</p>
                    <audio id="audiopart" class="audiopart max-w-full h-8" data-id-part="{{ $part->id_part }}" controls controlsList="nodownload">
                ...
                <div class="border border-slate-100 rounded-xl p-2 bg-slate-50 self-start mt-1 cursor-zoom-in group relative">
                    <img src="{{asset('storage/gambar/'.$part->gambar->gambar)}}" alt="gambar part soal" class="zoomable-image max-h-64 object-contain rounded-lg">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="w-full flex flex-col gap-3">
                        ...
                        <div class="bg-slate-50 rounded-xl p-2 border border-slate-100 sm:w-max">
                            <audio class="audio max-w-full h-8 w-full" data-id-soal="{{ $data->id_soal }}" controls controlsList="nodownload">
