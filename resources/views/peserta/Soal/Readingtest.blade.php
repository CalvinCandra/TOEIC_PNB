            ...
            @foreach ($soalReading as $data)
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden relative">
                    ...
                    <div class="p-5 md:p-6">
                        ...
                        @if (!empty($data->text))
                            <div
                                class="bg-slate-50 border border-slate-200 rounded-xl p-4 md:p-5 mb-5 prose max-w-none prose-slate text-slate-800 leading-loose text-[14px]">
                                {!! $data->text !!}
                            </div>
                        @endif
                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <div class="w-full flex flex-col gap-3">
                                ...
                                @if (!empty($data->id_audio))
                                    ...
                                    @else
                                        <p class="text-[11px] text-slate-500 italic px-2"><i
                                                class="fa-solid fa-circle-info"></i> Audio has already played</p>
                                    @endif
                                @else
