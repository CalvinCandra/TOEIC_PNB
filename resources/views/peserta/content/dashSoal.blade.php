...
@endif
    ...
    <a data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
        class="relative flex flex-col md:flex-row items-stretch bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 group transition-all duration-300">
        
        <img class="object-cover w-full md:w-48 md:rounded-none md:rounded-s-lg"
            src="{{ asset('img/English.png') }}" alt="English Image">
        
        <!-- Tambahin pl-6 di sini buat geser teks ke kanan -->
        <div class="flex flex-col justify-between p-4 leading-normal pl-9">
            ...
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">
                ...
                <br><br>
                You will spend approximately 120 minutes (2 hours) for this test. There will be countdown timer:
                <br>
