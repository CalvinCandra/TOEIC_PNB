...
@section('Title', 'Dashboard Staff | Part Question')
                            ...
                            <tr class="border-b" id="baris{{$loop->iteration}}">
                                ...
                                <td class="px-4 py-3 border-2 whitespace-nowrap">
                                    <ul class="flex py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                        <li>
                                            <button onclick="edit('baris{{$loop->iteration}}', '{{$data->id_part}}')"
                                        ...
                                        <li>
                                            <button onclick="hapus('baris{{$loop->iteration}}', '{{$data->id_part}}')"
    ...
    <div class="relative w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4 modal-form" action="{{url('/TambahPartListeningPetugas')}}" method="POST"
                    ...
                    <div>
                        ...
                        {{-- <textarea rows="5" name="petunjuk"
                            ...
                            placeholder="Direction" required></textarea> --}}
                    </div>
...
<div id="UpdatePart{{$data->id_part}}" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-4xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <!-- Modal body -->
            <div class="p-4 md:p-5">
                <form class="space-y-4 modal-form" action="{{url('/UpdatePartListeningPetugas')}}" method="POST">
                    @csrf
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow ">
            ...
            <div class="flex justify-center items-center space-x-4">
                <form class="modal-form" action="{{url('/DeletePartListeningPetugas')}}" method="POST">
                    @csrf
