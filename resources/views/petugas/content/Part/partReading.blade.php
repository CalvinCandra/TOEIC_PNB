        ...
        <div class="relative w-full max-w-4xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4 modal-form" action="{{ url('/TambahPartReadingPetugas') }}" method="POST"
        ...
        <div id="UpdatePart{{ $data->id_part }}" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-4xl max-h-full">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <!-- Modal body -->
                    <div class="p-4 md:p-5">
                        <form class="space-y-4 modal-form" action="{{ url('/UpdatePartReadingPetugas') }}"
                            method="POST">
                            @csrf
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    <div class="flex items-center">
                                        <label for="name"
                                            class="mb-2 block text-sm font-semibold text-gray-900">From</label>
                                        <input type="input" name="dari_nomor" min="1"
